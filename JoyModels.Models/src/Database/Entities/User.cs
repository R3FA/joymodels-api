...
public partial class User
{
    ...
    public virtual ICollection<CommunityPostQuestionSection> CommunityPostQuestionSectionUserOriginUus { get; set; } = new List<CommunityPostQuestionSection>();

    public virtual ICollection<CommunityPostQuestionSection> CommunityPostQuestionSectionUserTargetUus { get; set; } = new List<CommunityPostQuestionSection>();
    ...
    public virtual ICollection<ModelFaqSection> ModelFaqSectionUserOriginUus { get; set; } = new List<ModelFaqSection>();

    public virtual ICollection<ModelFaqSection> ModelFaqSectionUserTargetUus { get; set; } = new List<ModelFaqSection>();
