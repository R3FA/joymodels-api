...
public class ModelReviewsController(IModelReviewService service) : ControllerBase
{
    ...
    [HttpGet("has-user-reviewed/{modelUuid:guid}")]
    public async Task<ActionResult<bool>> HasUserReviewed([FromRoute] Guid modelUuid)
    {
        return await service.HasUserReviewed(modelUuid);
    }
