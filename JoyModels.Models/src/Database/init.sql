...
LOCK
TABLES `community_post_pictures` WRITE;
...
LOCK
TABLES `community_post_question_section` WRITE;
...
LOCK
TABLES `community_post_review_types` WRITE;
...
LOCK
TABLES `community_post_types` WRITE;
...
LOCK
TABLES `community_post_user_reviews` WRITE;
...
LOCK
TABLES `model_availability` WRITE;
...
LOCK
TABLES `model_faq_section` WRITE;
...
LOCK
TABLES `model_review_types` WRITE;
